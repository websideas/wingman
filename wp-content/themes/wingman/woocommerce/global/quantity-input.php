...
<div class="quantity-group clearfix">
    <!--<span><?php _e('Quantity:', THEME_LANG) ?></span>-->
    ...
    <button type="button" class="quantity-plus"><i class="fa fa-angle-up"></i></button>
    <button type="button" class="quantity-minus"><i class="fa fa-angle-down"></i></button>
</div>
