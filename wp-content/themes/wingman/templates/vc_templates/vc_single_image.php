...
if( $show_social == 'yes' ){
    $social .= '<ul class="share clearfix">';
        $social .= '<li><a class="pinterest" target="_blank" href="http://pinterest.com/pin/create/button/?url='.urlencode(get_permalink(get_the_ID())).'&amp;media='.$img['p_img_large'][0].'&amp;description='.urlencode(get_the_title(get_the_ID())).'"><i class="fa fa-pinterest-p"></i></a></li>';
        $social .= '<li><a class="facebook" href="http://www.facebook.com/sharer.php?u='.urlencode(get_permalink(get_the_ID())).'&picture='.$img['p_img_large'][0].'" target="_blank"><i class="fa fa-facebook"></i></a></li>';
        $social .= '<li><a class="googleplus" target="_blank" href="https://plus.google.com/share?url='.urlencode(get_permalink(get_the_ID())).'"><i class="fa fa-google-plus"></i></a></li>';
    $social .= '</ul>';
}

$html = ( 'vc_box_shadow_3d' === $style ) ? '<span class="vc_box_shadow_3d_wrap">' . $img['thumbnail'] . '</span>' : $img['thumbnail'];
$html = '<div class="vc_single_image-wrapper ' . $style . ' ' . $border_color . '">' . $html . $social . '</div>';
