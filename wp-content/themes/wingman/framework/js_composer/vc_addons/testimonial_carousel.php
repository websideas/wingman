...
vc_map( array(
    "name" => __( "Testimonial Carousel", 'wingman'),
    ...
    "params" => array(
        ...
        array(
            'type' => 'dropdown',
            'heading' => __( 'Layout', 'wingman' ),
            'param_name' => 'layout',
            'value' => array(
                __( 'Layout 1', 'wingman' ) => '1',
                __( 'Layout 2', 'wingman' ) => '2',
            ),
        ...
        array(
            "type" => "kt_heading",
            "heading" => __("Author typography", 'wingman'),
        ...
        array(
            "type" => "kt_heading",
            "heading" => __("Company typography", 'wingman'),
