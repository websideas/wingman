...
function kt_add_option_to_vc() {
    ...
    foreach($color_arr as $item){
        ...
        $button_colors['value'][esc_html__( 'Accent color', 'wingman' )] = 'accent';
    ...
    $image_styles['value'][esc_html__( 'Border box', 'wingman' )] = 'border-box';
    $image_styles['value'][esc_html__( 'Border box Left', 'wingman' )] = 'border-left';
    $image_styles['value'][esc_html__( 'Border box Right', 'wingman' )] = 'border-right';
    $image_styles['value'][esc_html__( 'Creative Left', 'wingman' )] = 'creative-left';
    $image_styles['value'][__( 'Creative Right', 'wingman' )] = 'creative-right';
    $image_styles['value'][esc_html__( 'Creative When hover', 'wingman' )] = 'creative-hover';
