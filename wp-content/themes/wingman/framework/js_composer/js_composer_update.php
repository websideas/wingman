...
function kt_add_option_to_vc() {
    ...
    foreach($color_arr as $item){
        ...
        $button_colors['value'][__( 'Accent color', 'wingman' )] = 'accent';
    ...
    $image_styles['value'][__( 'Border box', 'wingman' )] = 'border-box';
    $image_styles['value'][__( 'Border box Left', 'wingman' )] = 'border-left';
    $image_styles['value'][__( 'Border box Right', 'wingman' )] = 'border-right';
    $image_styles['value'][__( 'Creative Left', 'wingman' )] = 'creative-left';
    $image_styles['value'][__( 'Creative Right', 'wingman' )] = 'creative-right';
    $image_styles['value'][__( 'Creative When hover', 'wingman' )] = 'creative-hover';
