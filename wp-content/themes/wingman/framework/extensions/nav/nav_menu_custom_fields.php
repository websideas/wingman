    ...
    <div class="container-megamenu">
        <p class="field-icon description description-wide clearfix">
            <label for="menu-item-icon-<?php echo $item_id; ?>">
                <?php _e( 'Select icon of this item (set empty to hide). Ex: fa fa-home', KT_THEME_LANG); ?><br />
        ...
        <div class="wrapper-megamenu">
            <p class="field-enable description description-wide">
                <label for="menu-item-enable-<?php echo $item_id; ?>">
                    ...
                    <b><?php _e( 'Enable Mega Menu (only for main menu)', KT_THEME_LANG); ?></b>
                </label>
            </p>
                ...
                <div class="megamenu-layout-depth-0">
                    <p class="field-columns description description-wide">
                        <label for="menu-item-columns-<?php echo $item_id; ?>">
                            <?php _e( 'Mega Menu number of columns', KT_THEME_LANG); ?><br />
                    ...
                    <p class="field-layout description description-wide">
                        <label for="menu-item-layout-<?php echo $item_id; ?>">
                            <?php _e( 'Mega Menu layout', KT_THEME_LANG); ?><br />
                            <select id="menu-item-layout-<?php echo $item_id; ?>" name="menu-item-megamenu-layout[<?php echo $item_id; ?>]" class="widefat edit-menu-item-layout">
                                <option <?php selected($item->layout, 'default'); ?> value="default"><?php _e('Default', KT_THEME_LANG); ?></option>
                                <option <?php selected($item->layout, 'table'); ?> value="table"><?php _e('Table + Border', KT_THEME_LANG); ?></option>
                            </select>
                        </label>
                    </p>
                    <p class="field-width description description-wide">
                        <label for="menu-item-width-<?php echo $item_id; ?>">
                            <?php _e( 'Mega Menu width', KT_THEME_LANG); ?><br />
                            <select id="menu-item-width-<?php echo $item_id; ?>" name="menu-item-megamenu-width[<?php echo $item_id; ?>]" class="widefat edit-menu-item-width">
                                <option <?php selected($item->width, 'full'); ?> value="full"><?php _e('Full Width', KT_THEME_LANG); ?></option>
                                <option <?php selected($item->width, 'half'); ?> value="half"><?php _e('1/2', KT_THEME_LANG); ?></option>
                                <option <?php selected($item->width, 'three'); ?> value="three"><?php _e('3/4', KT_THEME_LANG); ?></option>
                                <option <?php selected($item->width, 'four'); ?> value="four"><?php _e('4/5', KT_THEME_LANG); ?></option>
                                <option <?php selected($item->width, 'five'); ?> value="five"><?php _e('9/10', KT_THEME_LANG); ?></option>
                            </select>
                        </label>
                    </p>
                    <p class="description description-position description-wide">
                        <label>
                            <?php _e( 'Mega menu position', KT_THEME_LANG); ?><br />
                            <select id="menu-item-position-<?php echo $item_id; ?>" name="menu-item-megamenu-position[<?php echo $item_id; ?>]" class="widefat edit-menu-item-position">
                                ...
                                <option <?php selected($item->position, 'left-menubar'); ?> value=""><?php _e( 'Left edge of menu bar', KT_THEME_LANG); ?></option>
                                <option <?php selected($item->position, 'right-menubar'); ?> value="right-menubar"><?php _e( 'Right edge of menu bar', KT_THEME_LANG); ?></option>
                                <option <?php selected($item->position, 'left-parent'); ?> value="left-parent"><?php _e( 'Left Edge of Parent item', KT_THEME_LANG); ?></option>
                                <option <?php selected($item->position, 'right-parent'); ?> value="right-parent"><?php _e( 'Right Edge of Parent item', KT_THEME_LANG); ?></option>
                            </select>
                        </label>
                    </p>
                </div>
                <div class="megamenu-layout-depth-1">
                    <p class="field-image description description-wide">
                        ...
                        <label for="menu-item-image-<?php echo $item_id; ?>">
                            <?php _e( 'Menu image', KT_THEME_LANG); ?><br />
                        ...
                        <span class="clearfix"></span>
                        <input type="button" class="button-secondary kt_image_menu" value="<?php _e('Upload image', KT_THEME_LANG); ?>" style="width: 100%;" />
                    </p>
                    <p class="field-clwidth description description-wide">
                        <label for="menu-item-clwidth-<?php echo $item_id; ?>">
                            <?php _e( 'Mega Menu Column Width - Overrides parent colum (in percentage, ex: 30%)', KT_THEME_LANG); ?><br />
                    ...
                    <p class="field-columntitle description description-wide">
                        <label for="menu-item-columntitle-<?php echo $item_id; ?>">
                            ...
                            <?php _e('Disable Mega Menu Column Title', KT_THEME_LANG); ?>
                        </label>
                    </p>
                    <p class="field-columnlink description description-wide">
                        <label for="menu-item-columnlink-<?php echo $item_id; ?>">
                            ...
                            <?php _e('Disable Mega Menu Column Link', KT_THEME_LANG); ?>
                        </label>
                    </p>
                    <p class="field-endrow description description-wide">
                        <label for="menu-item-endrow-<?php echo $item_id; ?>">
                            ...
                            <?php _e( 'End Row (Clear the next row and start a new one with next item)', KT_THEME_LANG); ?>
                        </label>
                    </p>
                    <p class="field-widget description description-wide">
                        <label for="menu-item-widget-<?php echo $item_id; ?>">
                            <?php _e('Mega Menu Widget Area', KT_THEME_LANG); ?><br />
                            ...
                            <select id="menu-item-widget-<?php echo $item_id; ?>" name="menu-item-megamenu-widget[<?php echo $item_id; ?>]" class="widefat edit-menu-item-widget">
                                <option value="0"><?php _e( 'Select Widget Area', KT_THEME_LANG); ?></option>
