...
define( 'KT_FW_DIR', KT_THEME_DIR.'/framework');
define( 'KT_FW_URL', KT_THEME_URL.'/framework');
define( 'KT_FW_EXT_DIR', KT_FW_DIR . '/extensions' );
define( 'KT_FW_EXT_URL', KT_FW_URL . '/extensions');
define( 'KT_FW_PLUGINS_DIR', KT_FW_DIR . '/plugins');
define( 'KT_FW_EXT_CUSTOM_DIR', KT_FW_DIR . '/extensions-custom');
define( 'KT_FW_EXT_CUSTOM_URL', KT_FW_URL . '/extensions-custom');


define( 'KT_FW_WIDGETS', KT_FW_DIR . '/widgets');

define( 'KT_FW_ASSETS', KT_FW_URL . '/assets' );
define( 'KT_FW_JS', KT_FW_ASSETS . '/js');
define( 'KT_FW_CSS', KT_FW_ASSETS . '/css');
define( 'KT_FW_IMG', KT_FW_ASSETS . '/images');
define( 'KT_FW_LIBS', KT_FW_ASSETS . '/libs');

define( 'KT_FW_CLASS', KT_FW_DIR . '/class');
define( 'KT_FW_DATA', KT_FW_DIR . '/data');
