...
class WOOCS_CONVERTER extends WP_Widget
{
    ...
    {
        parent::__construct(__CLASS__, __('WooCommerce Currency Converter', 'woocommerce-currency-switcher'), array(
            'classname' => __CLASS__,
            'description' => __('WooCommerce Currency Converter by realmag777', 'woocommerce-currency-switcher')
                )
        );
    }
